...
//
//	@Inject
//	private IMemberTreeDataProvider dataProvider;
//
//	@Test
...
//		HasDescendants descendants = dataProvider.retrieveMemberDescendants(dataProvider.retrieveMembersByName(memberName)
//				.get(0).getId());
...
//		HasAncestors ancestors = dataProvider.retrieveMemberAncestors(dataProvider.retrieveMembersByName(memberName).get(0)
//				.getId());
