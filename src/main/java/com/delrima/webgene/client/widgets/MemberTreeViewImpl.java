...
/**
 * Manages the display side of user-interaction logic such as: - Showing/Creating menu for each member tree item - Adding members to the tree item
 * 
...
public class MemberTreeViewImpl extends Composite implements MemberTreeView {
	...
	public MemberTreeViewImpl(MemberEditView memberEditDisplay, MemberLookupSuggestOracle oracle, TreeInterfaceCreatorService treeCreatorService) {
		...
		// search box
		mainPanel.add(WidgetUtils.getFlowPanelWithWidgets(	memberTreeSearchSuggestBox, new HTML("&nbsp;&nbsp;&nbsp;"), WidgetUtils.getFlowPanelWithWidgets(displayMode),
															new HTML("&nbsp;&nbsp;&nbsp;"), WidgetUtils.getFlowPanelWithWidgets(viewType), new HTML("&nbsp;&nbsp;&nbsp;"),
															WidgetUtils.getFlowPanelWithWidgets(addMemberButton)));
		// error message
